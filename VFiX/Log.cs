...
namespace VFiX
{
    internal static class Log
    {
        ...
        static Log()
        {
            ...
            {
                const string MOD_NAME = nameof(VFiX) + @"\";
                ...
                {
                    UnityEngine.Debug.LogError($"[{VFiXPlugin.PluginName}] Logger failed to determine caller path prefix length");
                    return 0;
                }
            }
        }
